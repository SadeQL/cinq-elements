...
export const HomepageWordings = {
	...
	homepageEndLine: `Lift isn't about finding yourself.\nLife is about creating yourself.\n— George Bernard Shaw`,
};
